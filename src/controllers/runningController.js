...
let CollectionName = process.env.RUNNING_SUB_GAME_PATH
...
// Create operation
const createRunningSubGame = async (req, res) => {
    try {
        const data = req.body;
...
const createRunningSubGameByCron = async () => {
    try {
...
const getAllRunningSubGame = async (req, res) => {
    try {
        const alldata = [];
...
const getRunningSubGameById = async (req, res) => {
    try {
...
const updateRunningSubGame = async (req, res) => {
    try {
        const docId = req.params.docId;
        const data = req.body;
...
// update by cron job
const updateRunningSubGameCurrentRoomId = async (id) => {
    try {
        const collName= process.env.CURRENT_ROOM_ID_CHANGE_COLLECTION;
        const docId = process.env.RUNNING_CURRENT_ROOM_ID_CHANGE_DOC_ID;
        const data = {
...
// Delete operation
const deleteRunningSubGame = async (req, res) => {
    try {
        const docId = req.params.docId;
...
module.exports = {
    createRunningSubGame,
    createRunningSubGameByCron,
    getAllRunningSubGame,
    getRunningSubGameById,
    updateRunningSubGame,
    updateRunningSubGameCurrentRoomId,
    deleteRunningSubGame,
};
