...
const authenticate = function (req, res, next) {
  try {
    ...
    let decodedToken = jwt.verify(token, "Project_11 Firebase project", { ignoreExpiration: true }, function (error, done) {
      if (error) {
...
//       let checkUser = await userModels.findById(paramBookId)
